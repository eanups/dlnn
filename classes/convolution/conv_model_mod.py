...
(x_train_orig, y_train_orig), (x_validation, y_validation) = mnist.load_data()
print ("Original MNIST data shape:", x_train_orig.shape)
print ("Original MNIST data shape:", y_train_orig.shape)

x_train = x_train_orig[:50000]
x_test = x_train_orig[50000:]
y_train = y_train_orig[:50000]
y_test = y_train_orig[50000:]
